...
public class MainMenu : UIMenu
{
    ...
    private void InitializeWaitingRoomSubMenu()
    {
        ...
        _cancelButton.clicked += OnWaitingRoomCancelButton;
    ...
    private void CloseWaitingRoomSubMenu()
    {
        _cancelButton.clicked -= OnWaitingRoomCancelButton;
    }

    private void OnWaitingRoomCancelButton()
    {
        ConnectionManager.Instance.Shutdown();
        RemoveSubMenu(CloseWaitingRoomSubMenu);
    }

    void OnWebSocketConnected()
    {
        AddSubMenu(_waitingRoomSubMenu, InitializeWaitingRoomSubMenu, true);
    }
