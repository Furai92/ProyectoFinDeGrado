...
public class HudStatusNotificationElement : MonoBehaviour
{
    ...
    public void SetUp(Camera c, GameEnums.DamageElement element, EnemyEntity target)
    {
        gameObject.SetActive(true);
        animT = 0;
        eventWorldPosition = target.transform.position;
        notificationText.text = sdb.StatusToString(element);
